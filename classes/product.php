...
<?php
	...
	class product
	{
		...
		public function insert_product($data,$files){
			...
			if($productName=="" || $brand=="" || $category=="" || $product_desc=="" || $price=="" || $type=="" || $file_name ==""){// kiểm tra rỗng
				$alert = "<span class='error'>Các trường không được rỗng !!!</span>";
				return $alert;
			}else{
				move_uploaded_file($file_temp,$uploaded_image); // lấy tên file tạm rồi upload 
		...
		public function getproduct_new_tuongtu(){
		...
		public function insertCompare($productid, $customer_id){
			...
			if($result_check_compare){
				$msg = "<span class='error'>Sản phẩm đã thêm vào so sánh trước đó</span>";
				return $msg;
			}else{
